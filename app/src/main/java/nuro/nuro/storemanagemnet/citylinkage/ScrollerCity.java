...
public class ScrollerCity extends View {
    ...
    private String TAG = "ScrollerCity";

    public ScrollerCity(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            // 绘制内容
            canvas.drawText(itemText, x + controlWidth / 2 + textRect.width() / 20, y + move + unitHeight / 2 + textRect.height() / 2, textPaint);
            Log.i(TAG, String.valueOf(x + controlWidth / 2 + textRect.width() / 20));
            Log.i(TAG, String.valueOf("x:"+x));
            Log.i(TAG, String.valueOf("controlWidth:"+controlWidth));
            Log.i(TAG, String.valueOf("textRect.width():"+textRect.width()));
        }
